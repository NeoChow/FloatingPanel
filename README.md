...
We're not able to use UISearchController with FloatingPanelController by the system design.

Because UISearchController automatically presents itself modally when a user interacts with the search bar. It swaps the superview of the search bar to the view managed by itself while it displays. As a result, FloatingPanelController can't control the search bar when UISearchController is active, as you can see from [the screen shot](https://github.com/SCENEE/FloatingPanel/issues/248#issuecomment-521263831).
